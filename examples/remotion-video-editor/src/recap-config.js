...
const RECAP_CONFIG = {
  ...
  clips: [
    {src: 'https://example.com/clip01.mp4', durationInFrames: 45, label: 'January'},
    {src: 'https://example.com/clip02.mp4', durationInFrames: 45, label: 'February'},
    {src: 'https://example.com/clip03.mp4', durationInFrames: 45},
    {src: 'https://example.com/clip04.mp4', durationInFrames: 45},
    {src: 'https://example.com/clip05.mp4', durationInFrames: 45, label: 'Spring Break'},
    {src: 'https://example.com/clip06.mp4', durationInFrames: 40},
    {src: 'https://example.com/clip07.mp4', durationInFrames: 40},
    {src: 'https://example.com/clip08.mp4', durationInFrames: 40, label: 'Summer'},
    {src: 'https://example.com/clip09.mp4', durationInFrames: 40},
    {src: 'https://example.com/clip10.mp4', durationInFrames: 40},
